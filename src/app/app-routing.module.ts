...
const routes: Routes = [
  ...
  {
    path: 'manage-card',
    loadChildren: () => import('./manage-card/manage-card.module').then( m => m.ManageCardPageModule)
  },
  {
    path: 'block-card',
    loadChildren: () => import('./block-card/block-card.module').then( m => m.BlockCardPageModule)
  },
  {
    path: 'offers',
